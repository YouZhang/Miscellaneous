...
class spider(SGMLParser):
    ...
    def publish(self,content):
        ...
        print '%s:\nyou have used %s update\ncontent:%s)'% (datetime.datetime.now(),self.email,postdata.get('content',''))



renrenspider=spider('yourEmail','password')
renrenspider.login()
content=raw_input('input the content you want to publish')
